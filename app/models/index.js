...
// defining lands table for lands table
db.lands = require("./lands.model.js")(sequelize, Sequelize);


// define realtion between and lands and user
db.lands.belongsTo(db.user, {
  foreignKey: "user_id"
}
);
